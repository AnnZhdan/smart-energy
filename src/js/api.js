...
async function fetchExercisesByFiltersAndKeyword(category, muscles, equipment, keyword, page, limit) {
    try {
...
async function subscribeToExerciseUpdates() {
    ...
    try {
        ...
        if (responseData.message) {
            console.log("Subscription successful. Received response:", responseData.message);
        } else {
